...
async function updateInstanceName() {
    try {
        ...
        document.title = 'PocketProfits';
        document.getElementById('instance-name').textContent = 'PocketProfits';
    }
}
...
function initModalHandling() {
    ...
    transactionForm.addEventListener('submit', async (e) => {
        ...
        try {
            ...
            const transactionTypeMessage = currentTransactionType === 'expense' ? 'Innage' : 'Winnings';
...
async function initMainPage() {
    ...
    document.getElementById('exportPdfBtn').addEventListener('click', async () => {
        try {
            ...
            const instanceName = config.instanceName || 'PocketProfits';
